import {
  ...
  require_dijkstra,
  require_encode_utf8
} from "./chunk-2ASBFWF5.js";
import {
  clsx_m_default,
  init_clsx_m
} from "./chunk-QC54WL72.js";
import {
  require_events
} from "./chunk-AVCPLUTX.js";
import {
  AddChainError,
  ...
  useSignMessage,
  useSwitchNetwork
} from "./chunk-TJU55PQ2.js";
import {
  init_lib22 as init_lib,
  lib_exports21 as lib_exports,
  lib_exports24 as lib_exports2
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-MD245OXT.js
...
var arbitrumIcon = {
  ...
  iconUrl: async () => (await import("./arbitrum-RJBKFWDE-3CDXU26H.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-GTODSNSK-GDSGGXT2.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-JHU6THII-X2QAXJ4E.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-SVDDT6HW-WNAI3LDR.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-TCZSTHSI-OXPEK6PA.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-VJNBZ2P3-ALZLUVN5.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-3QUIF6AD-SP3YYSIB.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-3QOW27A7-UPNKC65S.js")).default
};
...
var src = async () => (await import("./assets-7THATBKH-53MOGAD7.js")).default;
...
var src2 = async () => (await import("./login-EJZTP74Q-DJUFNMI5.js")).default;
...
var signInIcon = async () => (await import("./sign-3FIRYJVD-6EOZ2N2Y.js")).default;
...
var src3 = async () => (await import("./create-GVGWOEGN-XBLIYS2R.js")).default;
...
var src4 = async () => (await import("./refresh-J4PXTKTR-Y7XU7FNJ.js")).default;
...
var src5 = async () => (await import("./scan-RESLZYEA-SW7AADAW.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Chrome":
      return (await import("./Chrome-J3SNM3VC-MNNA2JRK.js")).default;
    case "Brave":
      return (await import("./Brave-AYENFWW6-NW6HPSYC.js")).default;
    case "Edge":
      return (await import("./Edge-L7ZZC477-SBCWID24.js")).default;
    case "Firefox":
      return (await import("./Firefox-JUUNEJSG-TGZ4H7Y2.js")).default;
    default:
      return (await import("./Browser-MZYY2QO6-SEXD3ZPF.js")).default;
  }
};
...
var WalletConnectLegacyConnector = class extends Connector {
  ...
  async getProvider({
    ...
    if (!__privateGet(this, _provider) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-DBMNG5IK.js")).default;
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    var _a;
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("./dist-HHJ5WE4C.js")).default;
...
var SafeConnector = class extends Connector {
  ...
  async getAccount() {
    ...
    return (0, import_utils6.getAddress)(accounts[0]);
  }
  async getChainId() {
    const provider = await this.getProvider();
    if (!provider)
  ...
  async getProvider() {
    if (!__privateGet(this, _provider3)) {
      ...
      __privateSet(this, _provider3, new import_safe_apps_provider.SafeAppProvider(safe, __privateGet(this, _sdk)));
    }
...
var braveWallet = ({
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./braveWallet-VWIUQB2U-5WRG7CMS.js")).default,
    iconBackground: "#fff",
...
var coinbaseWallet = ({
  ...
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbaseWallet-VVDQG4AO-JM34D34S.js")).default,
    iconAccent: "#2c5ff6",
...
var injectedWallet = ({
  ...
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-UM67Z7WG-YNTQTR57.js")).default,
  iconBackground: "#fff",
...
var metaMaskWallet = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMaskWallet-F3BDZH5W-W3VOW3AE.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    id: "rainbow",
    name: "Rainbow",
    iconUrl: async () => (await import("./rainbowWallet-KSMGN6MJ-ZSPUBM4G.js")).default,
...
var safeWallet = ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-3KUD3U5G-XX6TV35D.js")).default,
...
var walletConnectWallet = ({
  ...
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnectWallet-GTSESN7Q-ID2GZZRP.js")).default,
